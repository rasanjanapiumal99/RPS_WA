...
<p align="center">
  <a href="https://github.com/rasanjanapiumal99/RPS_WA/fork">
    <img src="https://img.shields.io/github/forks/phaticusthiccy/WhatsAsenaDuplicated?label=Fork&style=social">
    
  </a>
  <a href="https://github.com/rasanjanapiumal99/RPS_WA/stargazers">
...
> [Install Guide/Kurulum Yardımcısı/Qurulum Müavin](https://github.com/rasanjanapiumal99/RPS_WA/wiki)
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/rasanjanapiumal99/RPS_WA)

> [WhatsAsena Wiki (Full Guide)](https://github.com/rasanjanapiumal99/RPS_WA/wiki) 

### The Hard Method (Not Recommend)
```js
$ git clone https://github.com/rasanjanapiumal99/RPS_WA.git
$ cd WhatsAsenaDuplicated
$ npm i
$ nano config.env
// Config.env oluşturun ve düzenleyin. Örnek: https://github.com/rasanjanapiumal99/RPS_WA/wiki/config.env-Example
// Create Config.env and edit it. Examle: https://github.com/rasanjanapiumal99/RPS_WA/wiki/config.env-Example
$ node bot.js
```
...
[![Setup - Kurulum](https://img.icons8.com/clouds/190/000000/settings.png)](https://github.com/rasanjanapiumal99/RPS_WA/wiki)
...
Only original [WhatsAsena](https://github.com/rasanjanapiumal99/RPS_WA) do this. It has own unique protection style inside WhatsAsena's database. It protect your phone from WhatApp attacks. Thats mean all fake creations carries a big risk for users privacy.
