...
if (Config.LANG == 'TR' || Config.LANG == 'AZ') {
  noAPI = '*DeepAI API Key Bulunamadı!* \n*Lütfen Aşağıdaki Adresten Gerekli Adımları Takip Edin!*' + '\n\n*URL:* https://github.com/rasanjanapiumal99/RPS_WA/wiki/DeepAI-API-Key#-deepai-api-key-al%C4%B1c%C4%B1'
} else {
  noAPI = '*DeepAI API Key Not Found!* \n*Please Follow the Required Steps at the Address Below!*' + '\n\n*URL:* https://github.com/rasanjanapiumal99/RPS_WA/wiki/DeepAI-API-Key#-deepai-api-key-scraper'
}
