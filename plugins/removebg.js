...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'removebg ?(.*)', fromMe: true, desc: Lang.REMOVEBG_DESC}, (async (message, match) => {    
        ...
        if (Config.RBG_API_KEY === false) return await message.client.sendMessage(message.jid,Lang.NO_API_KEY.replace('remove.bg', 'https://github.com/rasanjanapiumal99/RPS_WA/wiki/Remove-BG-API-Key'),MessageType.text);
